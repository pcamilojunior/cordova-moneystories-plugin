...
/// Calling this method is obligatory as it provides the mandatory informations for salesup to work properly.
...
- (void)handleNotificationWithDate:(NSString * _Nonnull)date period:(NSString * _Nonnull)period;
@end
